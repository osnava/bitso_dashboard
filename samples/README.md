...
4. Download the following files, you'll need to rename them:
...
5. Place the downloaded CSV files in the root directory of this project (same level as `balance.py`)
